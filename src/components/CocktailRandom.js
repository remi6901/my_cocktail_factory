...
import "../styles/cocktailRandom.css"
    ...
    return(
        <div>
            ...
            {cocktailRandom && cocktailRandom.map((cocktail) =>(
                <div key={cocktail.idDrink} className="cocktailRandomPrincipalDiv">
                    <h2 className="cocktailRandomTitle">{cocktail.strDrink}</h2>
                    <div className="cocktailRandomDiv">
                        <div className="cocktailRandomDivImg" >
                            <img className="cocktailRandomImg" src={cocktail.strDrinkThumb} alt={cocktail.strDrink}/>
                        </div>
                        <div className="cocktailRandomDivRecip" >
                            <h3>Ingredients : </h3>
                            <ul className="cocktailRandomUl" >
                    ...
                    <button className="cocktailRandomButton" onClick={getCocktailRandom}>Surprise me again</button>
                </div>
            ))}
        </div>
    )
